...
db_handler = DatabaseHandler('postgresql://postgres:ai_cc_24@localhost:5432/ai_cc')
...
df, error_df = db_handler.get_dataframe_from_table('ai_cc_2602', column_names)
...
df_processed = data_generator.preprocess_data()

# Check the number of records before and after preprocessing
print("Number of records before preprocessing:", len(df))
print("Number of records after preprocessing:", len(df_processed))

# Create csv file
df = df_to_csv(df, 'ai_cc_2602.csv')